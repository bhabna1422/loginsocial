...
<head>
<meta charset="utf-8" />
<title>Advanced Security - PHP Register/Login System V2.0</title>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-7 col-md-6">
                        <div class="mr-lg-5">   
                            <img src="images/register.svg" class="img-fluid d-block mx-auto" alt="">
                        </div>
                    </div>
	...
	<div class="row">
		...
		<div class="col-md-12">
			<div class="form-group position-relative">
				...
				<a href="javascript:void(0)" onclick="showcpwd()" class="eye-visiable">
...
<li class="list-inline-item"><a href="social_signup.php?sm=Linkedin" class="rounded"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
		...
		<div class="mx-auto">
			<p class="mb-0 mt-3"><small class="text-dark mr-2">Already have an account ?</small> <a href="auth-login" class="text-dark font-weight-bold">Sign in</a></p>
		</div>
	</div>
</form>
                            </div>
