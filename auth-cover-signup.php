...
<li class="list-inline-item"><a href="social_signup.php?sm=Twitter" class="rounded"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
	...
	<div class="mx-auto">
		<p class="mb-0 mt-3"><small class="text-dark mr-2">Already have an account ?</small> <a href="auth-cover-login" class="text-dark font-weight-bold">Sign in</a></p>
	</div>
</div><!--end row-->
</form>  
                                        </div>
                    ...
                    <div class="col-lg-8 offset-lg-4 padding-less img order-1" style="background-image:url('images/register.jpg')"></div><!-- end col -->    
                </div><!--end row-->
