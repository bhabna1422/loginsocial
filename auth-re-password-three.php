...
$page 		= "reset";
$pageurl	= "auth-re-password-three";
...
<?php } ?>											
		...
		<div class="mx-auto">
			<p class="mb-0 mt-3"><small class="text-dark mr-2">Remember your password?</small> <a href="auth-login-three" class="text-dark font-weight-bold">Sign in</a></p>
		</div>
	</div>
</form>
                            </div>
